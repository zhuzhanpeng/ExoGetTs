 ...
 */
package com.google.android.exoplayer.custom.player;
...
public class HlsRendererBuilder implements DemoPlayer.RendererBuilder {
  ...
  private HlsChunkSource.PerTsCallback perTsCallback;

  public HlsRendererBuilder(Context context, String userAgent, String url) {
    this(context,userAgent,url,null);
  }
  public HlsRendererBuilder(Context context, String userAgent, String url, HlsChunkSource.PerTsCallback perTsCallback) {
    this.context = context;
    this.userAgent = userAgent;
    this.url = url;

    this.perTsCallback=perTsCallback;
  }
  @Override
  public void buildRenderers(DemoPlayer player) {
    currentAsyncBuilder = new AsyncRendererBuilder(context, userAgent, url, player,perTsCallback);
  ...
  private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url, DemoPlayer player) {
      this(context,userAgent,url,player,null);
    }
    public AsyncRendererBuilder(Context context, String userAgent, String url, DemoPlayer player, HlsChunkSource.PerTsCallback perTsCallback) {
      this.context = context;
      this.userAgent = userAgent;
      this.url = url;
      this.player = player;
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
      ...
      chunkSource.setPerTsCallback(perTsCallback);
