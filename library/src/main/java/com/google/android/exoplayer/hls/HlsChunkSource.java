...
public class HlsChunkSource implements HlsTrackSelector.Output {
  ...
  public interface PerTsCallback{
    void switchTs(String ts);
  }
  private PerTsCallback perTsCallback;
  public void setPerTsCallback(PerTsCallback perTsCallback){
    this.perTsCallback=perTsCallback;
  }

  private void notifyChangeTs(String ts){
    if(null != perTsCallback){
      perTsCallback.switchTs(ts);
    }
  }
